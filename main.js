// Html elementlerine ulasip obje olarak kullanma //
...
// Çalınacak şarkı listesini oluştur
const songsList = [
  {
    name: "Gelo Ew Ki Bu",
  ...
  },
  {
    ...
    artist: "Ebru Yaşar",
    image: "assets/ebru-yasar.jpeg",
  },
  {
    name: "Renklensin",
    link: "assets/renklensin.mp3",
    artist: "Reynmen",
    image: "assets/reynmen.jpeg",
  },
  {
    name: "Lan",
    link: "assets/lan.mp3",
...
// Anlık şarkıda geçen toplam saniye
audio.addEventListener("timeupdate", () => {
  currentTimeRef.innerText = timeFormatter(audio.currentTime);
});

// Progress alanı oluşturma
...
// Sonraki şarkıya geç butnonu tıklanıldığında
nextButton.addEventListener("click", nextSong);

// Geri butonu tıklanıldığında
